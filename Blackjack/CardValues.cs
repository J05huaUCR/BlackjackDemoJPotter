...
namespace Blackjack
{
    ...
    public enum CardIDs
    {
        C10, C2, C3, C4, C5, C6, C7, C8, C9, CJ, CQ, CK, CA,
        D10, D2, D3, D4, D5, D6, D7, D8, D9, DJ, DQ, DK, DA,
        H10, H2, H3, H4, H5, H6, H7, H8, H9, HJ, HQ, HK, HA,
        S10, S2, S3, S4, S5, S6, S7, S8, S9, SJ, SQ, SK, SA
    }
    ...
    public enum ImageX
    {
        C2 = 0, C3 = -143, C4 = -287, C5 = -430, C6 = -574, C7 = -717, C8 = -861, C9 = -1004, C10 = -1148,
